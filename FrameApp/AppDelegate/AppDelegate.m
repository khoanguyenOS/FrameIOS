...
@synthesize InternetConnectionFlag,dicUserInfo,dicUSerProfileInfo;
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    SingInRegisterViewController *loginVC = [[SingInRegisterViewController alloc] initWithNibName:@"SingInRegisterViewController" bundle:nil];
    ...
    NSString *str=[[NSUserDefaults standardUserDefaults] objectForKey:@"SBFormattedPhoneNumber"];
